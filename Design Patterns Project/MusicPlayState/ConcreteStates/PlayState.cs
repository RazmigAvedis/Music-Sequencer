...
{
    public class PlayState:MusicPlayerState
    {
        public PlayState(Button playButton)
        {
            playButton.BackgroundImage = Image.FromFile(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\..\Resources\Icons\Pause.png"));
            playButton.ForeColor = Color.Red;
        }
        public override void PlayButtonPressed(MusicMachine musicMachine,Button playButton)
        {
            musicMachine.State = new PauseState(playButton);
        }
